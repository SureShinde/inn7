...
namespace Magenest\ProductImageSwap\Block;

use Magenest\ProductImageSwap\Model\Config\Source\HoverElement;
use Magento\Framework\View\Element\Template;
use Magenest\ProductImageSwap\Model\Config\Source\Animation;
...
class CatalogImageHovering extends Template
{
    ...
    /**
     * @var \Magenest\ProductImageSwap\Helper\Data
     */
    protected $helper;

    /**
     * ProductImageSwap constructor.
     * @param Template\Context $context
     * @param \Magenest\ProductImageSwap\Helper\Data $helper
     * @param array $data
     */
    public function __construct(
        Template\Context $context,
        \Magenest\ProductImageSwap\Helper\Data $helper,
        array $data = []
    )
    {
        $this->helper = $helper;
