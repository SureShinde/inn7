    ...
    return Class.extend({
        ...
        initGallery: function () {
            ...
            $('.fotorama').on('fotorama:ready', function (e, fotorama) {
                $( ".fotorama__nav--thumbs .fotorama__nav__frame" ).each(function(index) {
                    $(this).attr('current-index',index+1);
                    if($(this).attr('data-active'))
                    {
                        $('.slider-count span.count').text(index+1);
                    }
                });
                $( ".fotorama__nav--thumbs .fotorama__nav__frame" ).on( "click", function() {
                    var index = $(this).attr('current-index');
